...
description: "Autonomous AI video editor for TikTok, Reels, and Shorts. Cuts raw footage, stitches reaction hooks + app/product demos, applies auto color grading, dynamic animated overlays (zoom punch, highlight rings), burns 17 authentic social caption styles via HyperFrames & FFmpeg, persists session memory, and conducts automated self-evaluation."
homepage: https://github.com/ArielleTolome/overlay-text-video-editor
metadata:
  tags: [video-editing, tiktok, reels, captions, hyperframes, openclaw, clawhub, hermes, grokbot, codex, claude-code]
  requires:
    bins: [bun, ffmpeg, ffprobe]
    optional_bins: [yt-dlp]
    env: [] # strictly zero mandatory paid API keys
triggers:
  - "video captions"
  - "tiktok captions"
  - "tiktok text overlay"
...
## 📦 Installation for AI Agents (OpenClaw, Hermes, Grokbot, Claude, Codex)
